...
public class JurusanPanel extends javax.swing.JPanel {
    ...
    public JurusanPanel() {
        initComponents();
        displayResult(jurusandao.getAllJurusan());
    }

    private void displayResult(List resultList) {
        Vector<String> tableHeaders = new Vector<String>();
        Vector tableData = new Vector();
        tableHeaders.add("ID Jurusan");
        tableHeaders.add("Nama Jurusan");
        tableHeaders.add("ID Fakultas");
        //tableHeaders.add("Operation");

        for (Object o : resultList) {
            TblJurusan jurusan = (TblJurusan) o;
            Vector<Object> oneRow = new Vector<Object>();
            oneRow.add(jurusan.getIdJurusan());
            oneRow.add(jurusan.getJurusan());
            oneRow.add(jurusan.getTblFakultas().getFakultas());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JurusanOperation in = new JurusanOperation(null);
//        in.setVisible(true);
//        this.dispose();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (rowindex != -1) {
            ...
            if (a == JOptionPane.YES_OPTION) {
                TblJurusan test = jurusandao.getJurusanById(Integer.parseInt(resultTable.getValueAt(rowindex, 0).toString()));
                jurusandao.deleteJurusan(test.getIdJurusan());
                Refresh();
            }
        } else {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (rowindex != -1) {
            TblJurusan test = jurusandao.getJurusanById(Integer.parseInt(resultTable.getValueAt(rowindex, 0).toString()));
            JurusanOperation in = new JurusanOperation(test);
//            in.setVisible(true);
//            this.dispose();
        } else {
    ...
    private void txtCariCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_txtCariCaretUpdate
        ...
        displayResult(jurusandao.getCariJurusan(txtCari.getText()));
