 ...
 * @author Bayu
 */
public class RuanganPanel extends javax.swing.JPanel {

    /**
     * Creates new form RuanganPanel
     */
    TblRuanganDao ruangdao = new TblRuanganDao();

    public RuanganPanel() {
        initComponents();
        displayResult(ruangdao.getAllRuangan());
    }

    private void displayResult(List resultList) {
        Vector<String> tableHeaders = new Vector<String>();
        Vector tableData = new Vector();
        tableHeaders.add("ID Ruangan");
        tableHeaders.add("Nama Ruangan");
        tableHeaders.add("Lantai");
        //tableHeaders.add("Operation");

        for (Object o : resultList) {
            TblRuangan ruang = (TblRuangan) o;
            Vector<Object> oneRow = new Vector<Object>();
            oneRow.add(ruang.getIdRuangan());
            oneRow.add(ruang.getNamaRuangan());
            oneRow.add(ruang.getLantai());
    ...
    private void txtCariCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_txtCariCaretUpdate
        ...
        displayResult(ruangdao.getCariRuangan(txtCari.getText()));
        //makuldao.getCariMakul(txtCari.getText());
    }//GEN-LAST:event_txtCariCaretUpdate

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        RuanganOperation in = new RuanganOperation(null);
//        in.setVisible(true);
//        this.dispose();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (rowindex != -1) {
            TblRuangan test = ruangdao.getRuanganById(Integer.parseInt(resultTable.getValueAt(rowindex, 0).toString()));
            RuanganOperation in = new RuanganOperation(test);
//            in.setVisible(true);
//            this.dispose();
        } else {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (rowindex != -1) {
            ...
            if (a == JOptionPane.YES_OPTION) {
                TblRuangan test = ruangdao.getRuanganById(Integer.parseInt(resultTable.getValueAt(rowindex, 0).toString()));
                ruangdao.deleteRuangan(test.getIdRuangan());
                Refresh();
            }
        } else {
