...
public class KelasPanel extends javax.swing.JPanel {
    ...
    public KelasPanel() {
        initComponents();
        displayResult(klsdao.getAllKelas());
    }
    ...
    private void displayResult(List resultList) {
        ...
        tableHeaders.add("Angkatan");
        //tableHeaders.add("Operation");

        for (Object o : resultList) {
            TblKelas kelas = (TblKelas) o;
            Vector<Object> oneRow = new Vector<Object>();
            oneRow.add(kelas.getIdKelas());
            oneRow.add(kelas.getKelas());
            oneRow.add(kelas.getAngkatan());
...
//        this.dispose();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (rowindex != -1) {
            TblKelas test = klsdao.getKelasById(Integer.parseInt(resultTable.getValueAt(rowindex, 0).toString()));
            KelasOperation in = new KelasOperation(test);
//            in.setVisible(true);
//            this.dispose();
        } else {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (rowindex != -1) {
            ...
            if (a == JOptionPane.YES_OPTION) {
                TblKelas test = klsdao.getKelasById(Integer.parseInt(resultTable.getValueAt(rowindex, 0).toString()));
                klsdao.deleteKelas(test.getIdKelas());
                Refresh();
            }
        } else {
